...
bool lk_ha_get_tuple(page_id_t first_page_id, Tuple *tuple, const TableSchema &tb_schema);

bool lk_ha_update_tuple(page_id_t first_page_id, const Tuple &tuple, const RID &rid, const TableSchema &tb_schema);
